...
export const MetaTracking = {
  ...
  // Video submission tracking helper (use this in React components)
  getVideoSubmissionTrackingData: (userData = {}) => ({
  ...
  // Leaderboard view tracking helper (use this in React components)
  getLeaderboardViewTrackingData: (userData = {}) => ({
    userData,
    content: {
