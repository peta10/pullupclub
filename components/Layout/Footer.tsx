      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            The premier destination for pull-up competitions and fitness challenges. Test your strength, compete with others, and climb the leaderboard.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li>support@pullupclub.com</li>
              <li>+1 (619) 363-4597</li>
              <li>871 Harold Pl, San Diego, CA 91914</li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>
            © {currentYear} Battle Bunker Pull-Up Club. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
